Pod::Spec.new do |s|
  ...
  s.social_media_url = "https://levinriegner.com/"
  s.authors = "Alex Queudot"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/Alqueraf/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
